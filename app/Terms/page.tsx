      ...
      <div className="space-y-8">
        ...
        <Card className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 border-purple-600/30">
          <CardContent className="p-6 md:p-8 text-center">
            ...
            <p className="text-gray-300 leading-relaxed max-w-2xl mx-auto">
              We are not providing any kind of refund. All purchases made through our platform are final and non-refundable, regardless of the circumstances. By completing a transaction, you acknowledge and accept this policy. We strongly encourage users to carefully review product or service details, eligibility, and compatibility before making any payment. If you have questions or concerns prior to a purchase, please contact our support team for clarification. Exceptions to this policy may only be made if required under applicable consumer protection laws. In such cases, the decision to issue a refund will be at the sole discretion of EliteCrows Infotech and must meet all legal conditions.</p>
